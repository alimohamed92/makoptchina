    ...
    <div class="wrapper d-flex align-items-stretch">
	    ...
	    <nav id="sidebar" class="active">
            ...
            <ul class="list-unstyled components mb-5">
                <li class="active">
                    <a href="<?php echo site_url('receveur'); ?>"><span class="fa fa-home"></span> Accueil</a>
                </li>
                <li>
                    <a href="<?php echo site_url('receveur/newDossier'); ?>"><span class="fa fa-folder-open"></span>Nouveau dossier</a>
                </li>
                <li>
                    <a href="<?php echo site_url('receveur/referents'); ?>"><span class="fa fa-address-card-o"></span> Contacts</a>
                </li>

                <li>
                    <a href="<?php echo site_url('receveur/signaler'); ?>"><span class="fa fa-paper-plane"></span>Signaler </a>
                </li>
            </ul>
