    ...
    <table class="table table-striped table-hover table-borderless" id="example" class="display" style="width:100%">
        ...
        <tbody>
            <?php foreach ($demandes as $demande) { ?>
                <tr id='det_<?php echo $demande['tel'] ?>' class="table-info tr-link <?php if($demande['etat'] == EN_ATTENTE) { echo 'table-warning';?>"
                    <?php echo 'data-toggle="tooltip" data-placement="top" title="en attente de confirmation"';} ?>>
